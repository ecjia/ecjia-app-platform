...
class merchant extends ecjia_merchant {
	...
	public function wechat_extend() {
		...
		$this->assign('form_action', RC_Uri::url('platform/merchant/wechat_extend_insert'));
	...
	public function wechat_extend_insert() {
		...
		if ($id) {
			return $this->showmessage(RC_Lang::get('platform::platform.add_pubext_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/merchant/wechat_extend', array('id' => $id))));
		} else {
	...
	public function wechat_extend_edit() {
		...
		$this->assign('action_link', array('text' => RC_Lang::get('platform::platform.public_extend'), 'href' => RC_Uri::url('platform/merchant/wechat_extend', array('id' => $id))));
		$this->assign('form_action', RC_Uri::url('platform/merchant/wechat_extend_save'));
	...
	public function wechat_extend_save() {
		...
		if ($update) {
			return $this->showmessage(RC_Lang::get('platform::platform.edit_pub_extend_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/merchant/wechat_extend_edit', array('code' => $ext_code, 'id' => $account_id))));
		} else {
	...
	public function wechat_extend_remove() {
		...
		if ($success){
			return $this->showmessage(RC_Lang::get('platform::platform.remove_pub_extend_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/merchant/wechat_extend', array('id' => $id))));
		} else {
	...
	public function batch_remove() {
		...
		return $this->showmessage(RC_Lang::get('platform::platform.deleted')."[ ".$count." ]".RC_Lang::get('platform::platform.record_account'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/merchant/init')));
	}
