        ...
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item"><a class="navbar-brand" href="index.html"><img class="brand-logo" alt="robust admin logo" src="../../../content/apps/platform/statics/platform/images/logo/logo-dark-sm.png">
                <h3 class="brand-text">ECJia公众平台</h3></a></li>
        ...
        <div class="navbar-container content">
          <div class="collapse navbar-collapse" id="navbar-mobile">
            <ul class="nav navbar-nav mr-auto float-left">
              <li class="nav-item d-none d-md-block"><a class="nav-link nav-menu-main menu-toggle hidden-xs" href="icons-simple-line-icons.html#"><i class="ft-menu">         </i></a></li>
              <li class="dropdown nav-item mega-dropdown"><a class="dropdown-toggle nav-link" href="icons-simple-line-icons.html#" data-toggle="dropdown">Mega</a>
                    ...
                    <ul class="drilldown-menu">
                      <li class="menu-list">
                        <ul>
                          ...
                          <li><a href="icons-simple-line-icons.html#"><i class="ft-align-left"></i> Multi level menu</a>
                            <ul>
                              <li><a class="dropdown-item" href="icons-simple-line-icons.html#"><i class="fa fa-file-o"></i>  Second level</a></li>
                              <li><a href="icons-simple-line-icons.html#"><i class="fa fa-star-o"></i> Second level menu</a>
                                <ul>
                                  <li><a class="dropdown-item" href="icons-simple-line-icons.html#"><i class="fa fa-heart"></i>  Third level</a></li>
                                  <li><a class="dropdown-item" href="icons-simple-line-icons.html#"><i class="fa fa-heart"></i> Third level</a></li>
                                  <li><a class="dropdown-item" href="icons-simple-line-icons.html#"><i class="fa fa-heart"></i> Third level</a></li>
                                  <li><a class="dropdown-item" href="icons-simple-line-icons.html#"><i class="fa fa-heart"></i> Third level</a></li>
                                </ul>
                              </li>
                              <li><a class="dropdown-item" href="icons-simple-line-icons.html#"><i class="fa fa-film"></i> Second level, third link</a></li>
                              <li><a class="dropdown-item" href="icons-simple-line-icons.html#"><i class="fa fa-envelope-o"></i> Second level, fourth link</a></li>
                            </ul>
                          </li>
                          <li><a class="dropdown-item" href="color-palette-primary.html"><i class="ft-camera"></i> Color palette system</a></li>
                          <li><a class="dropdown-item" href="https://pixinvent.com/bootstrap-admin-template/robust/html/ltr/vertical-content-menu-template/sk-2-columns.html"><i class="ft-edit"></i> Page starter kit</a></li>
              ...
              <li class="nav-item nav-search"><a class="nav-link nav-link-search" href="icons-simple-line-icons.html#"><i class="ficon ft-search"></i></a>
