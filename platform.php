...
// 		RC_Script::enqueue_script('generate_token', RC_App::apps_url('statics/js/generate_token.js', __FILE__), array(), false, true);
		...
		ecjia_screen::get_current_screen()->add_nav_here(new admin_nav_here(RC_Lang::get('platform::platform.platform_list'), RC_Uri::url('platform/platform/init')));
	}
...
// 		$this->admin_priv('platform_config_manage');
		...
		$this->assign('action_link', array('text' => RC_Lang::get('platform::platform.platform_add'), 'href' => RC_Uri::url('platform/platform/add')));
		
		$wechat_list = $this->wechat_list();
		$this->assign('wechat_list', $wechat_list);
		$this->assign('search_action', RC_Uri::url('platform/platform/init'));
...
// 		$this->admin_priv('platform_config_add');
		...
		$this->assign('action_link', array('text' => RC_Lang::get('platform::platform.platform_list'), 'href'=>RC_Uri::url('platform/platform/init')));
		$this->assign('form_action', RC_Uri::url('platform/platform/insert'));
	...
	public function insert() {
		...
		return $this->showmessage(RC_Lang::get('platform::platform.add_pub_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/platform/edit', array('id' => $id))));
	}
	...
	public function edit() {
		...
		$this->assign('form_action', RC_Uri::url('platform/platform/update'));
	...
	public function update() {
		...
		return $this->showmessage(RC_Lang::get('platform::platform.edit_pub_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/platform/edit', array('id' => $id))));
	}
	...
	public function remove()  {
		...
		if ($success) {
			...
			return $this->showmessage(RC_Lang::get('platform::platform.remove_pub_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/platform/init')));
		} else {
	...
	public function toggle_show() {
		...
		return $this->showmessage(RC_Lang::get('platform::platform.switch_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('content' => $val, 'pjaxurl' => RC_Uri::url('platform/platform/init')));
	}
		...
		if (!empty($sort)) {
			if (!is_numeric($sort)) {
				...
				if ($this->db_platform_account->where(array('id' => $id))->update(array('sort' => $sort))) {
					return $this->showmessage(RC_Lang::get('platform::platform.editsort_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_uri::url('platform/platform/init')));
				} else {
	...
	public function wechat_extend() {
		...
		$this->assign('form_action', RC_Uri::url('platform/platform/wechat_extend_insert'));
	...
	public function wechat_extend_insert() {
		...
		if ($id) {
			return $this->showmessage(RC_Lang::get('platform::platform.add_pubext_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/platform/wechat_extend', array('id' => $id))));
		} else {
	...
	public function wechat_extend_edit() {
		...
		$this->assign('action_link', array('text' => RC_Lang::get('platform::platform.public_extend'), 'href' => RC_Uri::url('platform/platform/wechat_extend', array('id' => $id))));
		$this->assign('form_action', RC_Uri::url('platform/platform/wechat_extend_save'));
	...
	public function wechat_extend_save() {
		...
		if ($update) {
			return $this->showmessage(RC_Lang::get('platform::platform.edit_pub_extend_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/platform/wechat_extend_edit', array('code' => $ext_code, 'id' => $account_id))));
		} else {
	...
	public function wechat_extend_remove() {
		...
		if ($success){
			return $this->showmessage(RC_Lang::get('platform::platform.remove_pub_extend_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/platform/wechat_extend', array('id' => $id))));
		} else {
	...
	public function batch_remove() {
		...
		return $this->showmessage(RC_Lang::get('platform::platform.deleted')."[ ".$count." ]".RC_Lang::get('platform::platform.record_account'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/platform/init')));
	}
