 ...
 * ECJIA平台、公众号配置
 */
class mh_platform extends ecjia_merchant {
	...
	public function __construct() {
		...
		ecjia_screen::get_current_screen()->add_nav_here(new admin_nav_here(RC_Lang::get('platform::platform.platform_list'), RC_Uri::url('platform/mh_platform/init')));
	}
	...
	public function init() {
		...
		$this->assign('action_link', array('text' => RC_Lang::get('platform::platform.platform_add'), 'href'=>RC_Uri::url('platform/mh_platform/add')));
		
		$wechat_list = $this->wechat_list();
		$this->assign('wechat_list', $wechat_list);
		$this->assign('search_action', RC_Uri::url('platform/mh_platform/init'));
	...
	public function add() {
		...
		$this->assign('action_link', array('text' => RC_Lang::get('platform::platform.platform_list'), 'href'=>RC_Uri::url('platform/mh_platform/init')));
		$this->assign('form_action', RC_Uri::url('platform/mh_platform/insert'));
	...
	public function insert() {
		...
		return $this->showmessage(RC_Lang::get('platform::platform.add_pub_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/mh_platform/edit', array('id' => $id))));
	}
	...
	public function edit() {
		...
		$this->assign('form_action', RC_Uri::url('platform/mh_platform/update'));
	...
	public function remove()  {
		...
		if ($success) {
			...
			return $this->showmessage(RC_Lang::get('platform::platform.remove_pub_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/mh_platform/init')));
		} else {
	...
	public function toggle_show() {
		...
		return $this->showmessage(RC_Lang::get('platform::platform.switch_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('content' => $val, 'pjaxurl' => RC_Uri::url('platform/mh_platform/init')));
	}
	...
	public function wechat_extend() {
		...
		$this->assign('form_action', RC_Uri::url('platform/mh_platform/wechat_extend_insert'));
	...
	public function wechat_extend_insert() {
		...
		foreach ($data as $k => $v) {
			...
			ecjia_merchant::admin_log(RC_Lang::get('platform::platform.extend_name_is').$info['ext_name'].'，'.RC_Lang::get('platform::platform.public_name_is').$info['name'], 'batch_insert', 'wechat_extend');
		}
		if ($id) {
			return $this->showmessage(RC_Lang::get('platform::platform.add_pubext_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/mh_platform/wechat_extend', array('id' => $id))));
		} else {
	...
	public function wechat_extend_edit() {
		...
		$this->assign('action_link', array('text' => RC_Lang::get('platform::platform.public_extend'), 'href' => RC_Uri::url('platform/mh_platform/wechat_extend', array('id' => $id))));
		$this->assign('form_action', RC_Uri::url('platform/mh_platform/wechat_extend_save'));
	...
	public function wechat_extend_save() {
		...
		ecjia_merchant::admin_log(RC_Lang::get('platform::platform.extend_name_is').$info['ext_name'].'，'.RC_Lang::get('platform::platform.public_name_is').$info['name'], 'edit', 'wechat_extend');

		if ($update) {
			return $this->showmessage(RC_Lang::get('platform::platform.edit_pub_extend_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/mh_platform/wechat_extend_edit', array('code' => $ext_code, 'id' => $account_id))));
		} else {
	...
	public function wechat_extend_remove() {
		...
		ecjia_merchant::admin_log(RC_Lang::get('platform::platform.extend_name_is').$info['ext_name'].'，'.RC_Lang::get('platform::platform.public_name_is').$info['name'], 'remove', 'wechat_extend');
		if ($success){
			return $this->showmessage(RC_Lang::get('platform::platform.remove_pub_extend_succeed'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('platform/mh_platform/wechat_extend', array('id' => $id))));
		} else {
